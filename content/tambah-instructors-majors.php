...
if(isset($_POST['id_majors'])){
  ...
  // $id_instructors = $_POST['id_instructors'];
   ...
   $insert = mysqli_query($config, "INSERT INTO instructors_majors (id_majors,id_instructors) VALUES('$id_majors','$id')");
...
$queryInstructorsMajors = mysqli_query($config, "SELECT majors.name, instructors_majors.id, id_instructors FROM instructors_majors LEFT JOIN majors ON majors.id = instructors_majors.id_majors WHERE id_instructors = '$id' ORDER BY instructors_majors.id DESC");
...
<div class="row">
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Add Instructors Majors : <?php echo $rowInstructors['name']?> </h5>
        <div align="right">
